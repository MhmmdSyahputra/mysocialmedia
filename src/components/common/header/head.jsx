                        ...
                        {profilku.map((list, index) => (
                            <div className="profile">
                                ...
                                <div className="title-profile mb-5">
                                    ...
                                    <div className='effect mt-2 mb-2 '>
                                        <Link to="/myprofile" className=" rounded-pill ps-3 pe-3 link-profile" style={{ backgroundColor: "#282A35", color: '#9BB0A9', padding: '10px' }}>Profile</Link>
                                    </div>
                        ...
                        <div className="menu-left active ms-4">
                            <ul style={{ listStyle: 'none' }} className='text-start'>
                                ...
                                <Link to='/' className='link-menu'>
                                    <li className='effect'> <AiOutlineHome className='fs-4 me-3' /> Home</li>
                                </Link>
                                <Link to='/explore' className='link-menu'>
                                    <li className='effect' ><MdOutlineExplore className='fs-4 me-3' /> Explore</li>
                                </Link>
                                <Link to='/message' className='link-menu'>
                                    <li className='effect' ><AiOutlineMessage className='fs-4 me-3' /> Message</li>
                                </Link>
                                <Link to='/setting' className='link-menu'>
                                    <li className='effect' ><AiOutlineSetting className='fs-4 me-3' /> Setting</li>
                                </Link>
